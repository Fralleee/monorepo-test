			...
			<section className="panel stack">
				...
				<div className="grid">
					...
					<div className="stack">
						...
						<ul className="list">
							<li>
								SlashIDProvider uses <code>tokenStorage="cookie"</code>, so tokens are HTTP cookies, not localStorage.
							</li>
							<li>
								Server components and API routes validate the cookie with <code>@slashid/slashid</code> SSR helpers.
							</li>
							<li>
								Client components still use <code>useSlashID</code> for UI/UX checks.
							</li>
